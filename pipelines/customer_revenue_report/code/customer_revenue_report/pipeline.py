...
def pipeline(spark: SparkSession) -> None:
    ...
    df_calc_expenditure = calc_expenditure(spark, df_orders_ds)
    df_customer_ds = customer_ds(spark)
    df_Reformat_1 = Reformat_1(spark, df_customer_ds)
    df_Join_1 = Join_1(spark, df_calc_expenditure, df_Reformat_1)
    df_Repartition_1 = Repartition_1(spark, df_Join_1)
    df_OrderBy_1 = OrderBy_1(spark, df_Repartition_1)
    revenue_report(spark, df_OrderBy_1)
